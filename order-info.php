...
if (isset($data['do_signup'])){
    $result = R::load('order', $_GET['page']);
    $result -> transporter_phone = $_SESSION['logged_phone'];
    $result -> status = 'Підтвердження';
    R::store($result);
        ...
        <div class="row justify-content-center">
            <div class="col-md-11">
                <div class="order-information" >
                    ...
                    <form action="order-info.php?page=<?php echo $_GET['page'];?>" method="post">
                        <button class="butt-accept" type="submit" name="do_signup">Прийняти</button>>
                    </form>
                </div>
            </div>
        </div>
